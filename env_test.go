...
func mapProviderID(providers []middleauth.AuthProvider) (ids []string) {
...
func checkProvider(id string) func([]middleauth.AuthProvider) error {
	return func(providers []middleauth.AuthProvider) (err error) {
...
func TestFindProvider(t *testing.T) {
	found := middleauth.FindProvider(
		"world",
		[]middleauth.AuthProvider{
			{
				ID: "hello",
			},
			{
